...
* Zaimplementuj następujące algorytmy sortowania: Insertion Sort, Merge Sort, Quick Sort oraz Radix Sort.
...
kompilacja:
    javac *.java
uruchamianie:
    java zad1 --type insert|merge|quick|radix --comp '<='|'>=' --stat filename.txt k
uwaga: sortowanie działa tylko dla liczb całkowitych.
uwaga: ze względu na działanie Garbage Collectora pomiary zużytej pamięci są niedokładne, a czasem mogą wyjść ujemne.
*/
