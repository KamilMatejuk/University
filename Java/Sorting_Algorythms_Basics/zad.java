...
gdzie:
	--stat generuje statystyki dla liczb całkowitych i n: {100, 200, ... 1000}
	--smallstat generuje statystyki dla liczb całkowitych i n: {2, 3, 4, ... 100}
	--stat generuje statystyki dla ciagów alfanumerycznych i n: {100, 200, ... 1000}
	--smallstat generuje statystyki dla ciagów alfanumerycznych i n: {2, 3, 4, ... 100}
*/
